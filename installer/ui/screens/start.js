...
const ICONS = {
  ...
  chat:
    '<path d="M20.4 14.2a2.2 2.2 0 0 1-2.2 2.2H8.6L4.6 20V5.8a2.2 2.2 0 0 1 2.2-2.2h11.4a2.2 2.2 0 0 1 2.2 2.2Z"/>'
};
...
const LINKS = [
  ...
  },
  {
    icon: 'chat',
    lead: 'Community',
    value: 'discord.gg/gUGg4YSsg',
    url: 'https://discord.gg/gUGg4YSsg'
  }
];
...
function news() {
  ...
  ['beta', 'stable'].forEach((key) => {
    ...
    tab.addEventListener('click', () => {
      ...
      channel = key;
      Object.keys(buttons).forEach((k) => buttons[k].setAttribute('aria-pressed', String(k === key)));
      paint();
    });
    buttons[key] = tab;
