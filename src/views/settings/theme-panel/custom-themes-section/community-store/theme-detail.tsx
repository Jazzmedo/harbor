          ...
          <div className="grid gap-6 p-6 pb-0 sm:grid-cols-[1.15fr_1fr]">
            ...
            <div className="flex min-w-0 flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <MarketCta variant="acquire" size="md" state={state} onClick={run} label={tr("Get theme")} />
              ...
              <div className="flex items-center gap-2.5">
                <span className="text-[12.5px] font-medium text-ink-subtle">{tr("Rate this theme")}</span>
                <div className="flex items-center gap-0.5" role="group" aria-label={tr("Rate this theme")} onMouseLeave={() => setHover(0)}>
                  {[1, 2, 3, 4, 5].map((n) => (
                    <button
                      key={n}
                      onClick={() => rate(n)}
            ...
            {t.hasPendingUpdate && (
              <div className="flex items-start gap-2.5 rounded-md bg-surface px-3.5 py-3 text-[12.5px] leading-relaxed text-ink-muted ring-1 ring-edge-soft">
                ...
                <span>
                  ...
                  {tr("The author submitted a new version that's in review. You're seeing the current published version until it's approved.")}
                </span>
              </div>
            )}
