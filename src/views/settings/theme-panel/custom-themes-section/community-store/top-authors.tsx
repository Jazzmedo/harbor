  ...
  return (
    <section className="flex flex-col gap-5 ps-[9px]">
      <div className="flex flex-col">
        ...
        <p className="text-[12.5px] text-ink-subtle">{t("The most-downloaded creators in the community.")}</p>
      </div>
              ...
              <span className="flex min-w-0 flex-col">
                <span className="flex min-w-0 items-baseline gap-1.5">
                  {h ? (
                    ...
                    <span className="truncate text-[13.5px] font-semibold text-ink">{a.author === "Anonymous" ? t("Anonymous") : a.author}</span>
                  )}
                  {h && (
                ...
                <span className="flex items-center gap-1.5 text-[11.5px] text-ink-subtle">
                  <span>{a.count} {a.count === 1 ? t("theme") : t("themes")}</span>
