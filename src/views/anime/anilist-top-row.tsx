      ...
      <Row
        title={
          <span className="inline-flex items-center gap-2">
            ...
            <PinHomeButton id="anilist:trending" source="anilist" name="Trending on AniList" params={{ railKey: "trending" }} />
          </span>
        }
      ...
      <Row
        title={
          <span className="inline-flex items-center gap-2">
            ...
            <PinHomeButton id="anilist:top100" source="anilist" name="Top 100 on AniList" params={{ railKey: "top100" }} />
          </span>
        }
