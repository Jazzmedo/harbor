...
import { loadEBookResume, saveEBookResume } from "@/lib/ebook/reader-state";
import {
  listEBookProviders,
    ...
    void (async () => {
      const loadCatalog = async () => {
        ...
        for (let pageIndex = 0; pageIndex < 4; pageIndex++) {
          const page = await loadSourceEBookCatalogPage(providerId, nextCursor);
