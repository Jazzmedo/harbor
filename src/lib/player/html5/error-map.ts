...
export const HTML5_ERROR_SOURCE_KEYS = {
  decode:
    "Codec not supported in WebView2. Falling back is required, or pick a different stream.",
...
export type Html5ErrorSourceKey =
  (typeof HTML5_ERROR_SOURCE_KEYS)[Html5MediaErrorCode];
