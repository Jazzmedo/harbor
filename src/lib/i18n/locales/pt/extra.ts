const extra: Record<string, string> = {
  ...
  "Upscales SDR video with AI on an Nvidia RTX GPU (turn on RTX Video Super Resolution in the Nvidia app; needs GPU decode). Experimental. Unavailable while SVP is active for the current video.": "Amplia vídeo SDR com IA em uma GPU Nvidia RTX (ative o RTX Video Super Resolution no app da Nvidia; precisa de decodificação por GPU). Experimental. Indisponível enquanto o SVP estiver ativo para o vídeo atual.",
