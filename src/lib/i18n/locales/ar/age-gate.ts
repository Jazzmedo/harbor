const ageGate: Record<string, string> = {
  ...
  "A landlord asks for a \"deposit\" before move-in. What's it for?": "يطلب المالك «تأمينًا» قبل الانتقال إلى المسكن. ما الغرض منه؟",
  ...
  "You make an insurance claim. Before the insurer pays out, you usually:": "عندما تقدّم مطالبة تأمين، ماذا تفعل عادةً قبل أن تدفع شركة التأمين؟",
  ...
  "Friend asks you to \"co-sign\" a loan. You agree to:": "يطلب منك صديق أن تكون «ضامنًا» لقرضه. على ماذا توافق؟",
  ...
  "A bill is set up via \"direct debit\". The biller can:": "أُعدّت فاتورة للسداد عبر «الخصم المباشر». ماذا يستطيع مُصدر الفاتورة؟",
  ...
  "You only ever pay the minimum on a credit card each month. Over time you:": "تدفع الحد الأدنى فقط من رصيد بطاقتك الائتمانية كل شهر. ماذا يحدث بمرور الوقت؟",
  "Pay no interest as long as the minimum is met": "لا تدفع فائدة ما دمت تسدد الحد الأدنى",
  "Owe more, because interest keeps building on the rest": "يزداد ما تدين به لأن الفائدة تستمر في التراكم على الباقي",
  ...
  "A document needs to be \"notarised\". You take it to someone who will:": "تحتاج وثيقة إلى «تصديق كاتب العدل». ماذا يفعل الشخص الذي تأخذها إليه؟",
  ...
  "You're given \"power of attorney\" for a relative. You can:": "مُنحت «توكيلًا قانونيًا» عن قريب لك. ماذا يمكنك أن تفعل؟",
  ...
  "A laid-off employee receives \"severance\". That's:": "يتلقى موظف سُرّح من العمل «تعويض نهاية خدمة». ما هو؟",
  ...
  "A will names someone as \"executor\". Their job is to:": "تسمّي الوصية شخصًا «منفّذًا للوصية». ما مهمته؟",
  ...
  "Your payslip shows \"gross\" and \"net\" pay. Net is:": "تعرض قسيمة راتبك الأجر «الإجمالي» و«الصافي». ما الأجر الصافي؟",
  ...
  "You sign an \"NDA\" with a company. You're agreeing to:": "توقّع «اتفاقية عدم إفصاح» مع شركة. على ماذا توافق؟",
  ...
  "Interest rate on a loan is shown as a percentage. It tells you:": "يُعرض معدل فائدة القرض كنسبة مئوية. ماذا يوضح لك؟",
  ...
  "A charge on your bank app sits as \"pending\" for a day. The merchant is:": "تظهر عملية خصم في تطبيق البنك بحالة «معلّقة» ليوم. ماذا يفعل التاجر؟",
  ...
  "Your boss says \"submit your timesheet by Friday\". You're recording:": "يقول مديرك: «قدّم سجل ساعاتك بحلول الجمعة». ماذا تسجّل؟",
  ...
  "A new job's salary is \"pro-rated\" because you start mid-year. You'll receive:": "رُتب راتب وظيفة جديدة «بالتناسب» لأنك ستبدأ منتصف السنة. ماذا ستحصل عليه؟",
  ...
  "A subscription \"auto-renews\" at the end of the term. That means:": "اشتراك «يتجدد تلقائيًا» عند نهاية مدته. ماذا يعني ذلك؟",
  ...
  "A job offer's compensation is described as \"competitive\". That tells you:": "وُصف راتب عرض وظيفي بأنه «تنافسي». ماذا يعني ذلك؟",
  ...
  "You file a tax return as a \"sole proprietor\" or self-employed. You owe tax on:": "تقدّم إقرارًا ضريبيًا بصفتك «مالكًا فرديًا» أو عاملًا لحسابك. على أي مبلغ تدين بالضريبة؟",
