const ageGate: Record<string, string> = {
  ...
  "A landlord asks for a \"deposit\" before move-in. What's it for?": "Chủ nhà yêu cầu \"tiền đặt cọc\" trước khi chuyển vào. Khoản tiền này dùng để làm gì?",
  ...
  "Your account goes \"overdrawn\". What happened?": "Tài khoản của bạn bị \"thấu chi\". Điều gì đã xảy ra?",
  ...
  "You make an insurance claim. Before the insurer pays out, you usually:": "Bạn yêu cầu bồi thường bảo hiểm. Trước khi công ty bảo hiểm chi trả, thông thường bạn phải:",
  ...
  "Friend asks you to \"co-sign\" a loan. You agree to:": "Một người bạn nhờ bạn \"đồng ký tên\" khoản vay. Bạn đồng ý:",
  ...
  "You buy something \"in installments\". That means you:": "Bạn mua một món đồ theo hình thức \"trả góp\". Điều đó có nghĩa là bạn:",
  "Pay a one-time fee to reserve it": "Trả phí một lần để giữ món đồ",
  "Pay the total in smaller amounts over time": "Thanh toán tổng số tiền thành nhiều khoản nhỏ theo thời gian",
  ...
  "A bill is set up via \"direct debit\". The biller can:": "Một hóa đơn được thanh toán bằng hình thức \"ghi nợ trực tiếp\". Bên lập hóa đơn có thể:",
  ...
  "You only ever pay the minimum on a credit card each month. Over time you:": "Mỗi tháng, bạn chỉ thanh toán mức tối thiểu của thẻ tín dụng. Theo thời gian, bạn sẽ:",
  "Pay no interest as long as the minimum is met": "Không phải trả lãi miễn là đã thanh toán mức tối thiểu",
  "Owe more, because interest keeps building on the rest": "Nợ nhiều hơn vì phần còn lại tiếp tục phát sinh lãi",
  ...
  "The economy has \"inflation\". What's happening?": "Nền kinh tế đang có \"lạm phát\". Điều gì đang xảy ra?",
  ...
  "A document needs to be \"notarised\". You take it to someone who will:": "Một tài liệu cần được \"công chứng\". Bạn mang tài liệu đó đến người sẽ:",
  ...
  "You're given \"power of attorney\" for a relative. You can:": "Bạn được người thân trao \"giấy ủy quyền\". Bạn có thể:",
  ...
  "A laid-off employee receives \"severance\". That's:": "Một nhân viên bị cho thôi việc nhận được \"trợ cấp thôi việc\". Đó là:",
  ...
  "A will names someone as \"executor\". Their job is to:": "Di chúc chỉ định một người làm \"người thi hành di chúc\". Nhiệm vụ của họ là:",
  ...
  "Your payslip shows \"gross\" and \"net\" pay. Net is:": "Phiếu lương hiển thị lương \"trước thuế\" và lương \"thực nhận\". Lương thực nhận là:",
  ...
  "You sign an \"NDA\" with a company. You're agreeing to:": "Bạn ký \"NDA\" với một công ty. Nghĩa là bạn đồng ý:",
  ...
  "Interest rate on a loan is shown as a percentage. It tells you:": "Lãi suất khoản vay được hiển thị dưới dạng phần trăm. Lãi suất cho biết:",
  ...
  "A charge on your bank app sits as \"pending\" for a day. The merchant is:": "Một khoản thanh toán trên ứng dụng ngân hàng của bạn ở trạng thái \"đang chờ xử lý\" trong một ngày. Đơn vị bán hàng đang:",
  ...
  "Your boss says \"submit your timesheet by Friday\". You're recording:": "Sếp nói \"nộp bảng chấm công trước thứ Sáu\". Bạn đang ghi lại:",
  ...
  "A new job's salary is \"pro-rated\" because you start mid-year. You'll receive:": "Mức lương ở công việc mới được \"tính theo tỷ lệ\" vì bạn bắt đầu vào giữa năm. Bạn sẽ nhận được:",
  ...
  "A subscription \"auto-renews\" at the end of the term. That means:": "Gói đăng ký \"tự động gia hạn\" khi hết kỳ. Điều đó có nghĩa là:",
  ...
  "A job offer's compensation is described as \"competitive\". That tells you:": "Mức đãi ngộ trong thư mời làm việc được mô tả là \"cạnh tranh\". Điều đó cho biết:",
  ...
  "You file a tax return as a \"sole proprietor\" or self-employed. You owe tax on:": "Bạn khai thuế với tư cách \"chủ doanh nghiệp tư nhân\" hoặc người tự kinh doanh. Bạn phải nộp thuế trên:",
