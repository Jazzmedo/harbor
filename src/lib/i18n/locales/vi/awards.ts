const awards: Record<string, string> = {
  ...
  "No match found": "Không tìm thấy kết quả phù hợp",
  "Clear filters": "Xóa bộ lọc",
  "Search by recipient or title…": "Tìm theo người nhận giải hoặc tựa phim…",
  "All years": "Tất cả các năm",
  "Founded {year}": "Thành lập năm {year}",
  "{n} years": "{n} năm",
  "{n} year": "{n} năm",
  "Winning films & shows": "Phim điện ảnh và phim bộ đoạt giải",
  "View all {n} winners": "Xem tất cả {n} tác phẩm đoạt giải",
  "Celebrated actors": "Diễn viên được vinh danh",
  ...
  "{n} winner": "{n} tác phẩm đoạt giải",
  "{n} winners": "{n} tác phẩm đoạt giải",
};
