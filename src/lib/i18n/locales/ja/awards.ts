const awards: Record<string, string> = {
  ...
  "No match found": "一致する項目が見つかりません",
  "Clear filters": "フィルターをクリア",
  "Search by recipient or title…": "受賞者またはタイトルを検索…",
  "All years": "すべての年",
  "Founded {year}": "{year}年創設",
  "{n} years": "{n}年",
  "{n} year": "{n}年",
  "Winning films & shows": "受賞映画・番組",
  "View all {n} winners": "受賞作{n}件をすべて表示",
  "{n} title": "{n}タイトル",
  "{n} titles": "{n}タイトル",
  "Celebrated actors": "著名な俳優",
  ...
  "Search winners or categories…": "受賞作またはカテゴリーを検索…",
  "{n} winner": "受賞作{n}件",
  "{n} winners": "受賞作{n}件",
};
