const downloads: Record<string, string> = {
  "{count} downloading": "{count} descargando",
  "{count} items": "{count} elementos",
  "{path} (open folder)": "{path} (abrir carpeta)",
  "{shown} of {total} file from your computer": "{shown} de {total} archivo de tu computadora",
  "{shown} of {total} files from your computer": "{shown} de {total} archivos de tu computadora",
  "{size} saved": "{size} ahorrados",
  "1 item": "1 elemento",
  "Add files from your computer": "Agregar archivos desde tu computadora",
  "Add folder": "Agregar carpeta",
  "All complete": "Todo completo",
  "Cancel download": "Cancelar descarga",
  "Continue Watching screenshots": "Capturas de pantalla de Seguir viendo",
  "Couldn't scan that folder.": "No se pudo escanear esa carpeta.",
  "Delete download and file": "Eliminar descarga y archivo",
