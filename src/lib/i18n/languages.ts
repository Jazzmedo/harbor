...
export const LANGUAGES: LanguageOption[] = [
  ...
  { code: "zh", label: "Chinese (Simplified)", nativeLabel: "简体中文", greeting: "你好", rtl: false },
  ...
  { code: "id", label: "Indonesian", nativeLabel: "Bahasa Indonesia", greeting: "Halo", rtl: false },
...
const BY_CODE = Object.fromEntries(LANGUAGES.map((language) => [language.code, language])) as Record<
  UiLanguage,
  LanguageOption
>;
